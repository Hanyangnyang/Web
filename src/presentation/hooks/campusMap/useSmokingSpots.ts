...
import { visibleSmokingSpots, type SmokingSpot, type PlottableSmokingSpot } from '../../../domain/entities/SmokingSpot.js';
import { createStaticDataQuery, type StaticDataQueryOptions } from '../createStaticDataQuery.js';

const useSmokingSpotsQuery = createStaticDataQuery<SmokingSpot, PlottableSmokingSpot>({
  queryKey: ['campus', 'smokingSpots'],
  fetcher: () => getSmokingSpotsUseCase.execute(),
  errorMessage: '흡연장 정보를 불러오지 못했습니다.',
  select: visibleSmokingSpots,
});

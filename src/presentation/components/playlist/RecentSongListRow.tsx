...
export function RecentSongListRow({ song, onPlay, onRequireLogin }: RecentSongListRowProps) {
  ...
  return (
    <div className="flex items-center gap-2 p-2 bg-white rounded-xl border border-slate-200 shadow-[0_2px_4px_rgba(0,0,0,0.03)] hover:bg-slate-50 transition-colors">

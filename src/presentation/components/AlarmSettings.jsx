...
export function AlarmSettings({ onClose }) {
  ...
  return (
    ...
    >
      <div
        ref={sheetRef}
        className="w-[calc(100%-64px)] max-w-[300px] bg-white rounded-card px-5 pb-4 max-h-[90vh] overflow-y-auto mb-6 relative"
        style={{ 

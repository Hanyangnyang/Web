...
export const CLUBS: ClubInfo[] = [
  ...
  club('hy-pass', 'HY-PASS', '체육', '축구', '435호', 'hy__pass', [fee('20,000원', '남자'), fee('15,000원', '여자')], null, ['하이패스']),
  ...
  club('hany-baram', '하늬바람', '예술', '밴드', '404호', 'hany__baram', [fee('25,000원', '신규'), fee('20,000원', '재가입')]),
  ...
  club('powderive', '탁우회', '체육', '탁구', '411호', 'powerdrive_hanyang', [fee('25,000원')]),
  club('feel-so-good', '필소굿', '예술', '흑인음악', '415호', 'feelsooooooooooogood', [fee('15,000원', '신규'), fee('20,000원', '재가입')]),
  ...
  club('hanya', '한야', '체육', '야구부 서포터즈', null, 'hy_hanya', []),

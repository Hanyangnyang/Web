...
export const CLUBS: ClubInfo[] = [
  club('hema', 'HEMA', '예술', '밴드', '412호', 'hema_1991_', [fee('15,000원', '신규'), fee('40,000원', '재가입')], null, ['헤마', '일렉', '기타', '밴드', '음악']),
  ...
  club('moonge-cloud', '뭉게구름', '예술', '밴드', '420호', 'moonge_cloud', [fee('25,000원', '신규'), fee('20,000원', '재가입')], null, ['인디', '인디밴드', '노래', '음악', '기타']),
  club('martini', '마티니', '학술교양', '칵테일', '502호', 'hy_martini', [fee('35,000원', '신규'), fee('30,000원', '재가입')]),
  club('grim-ul', '그림얼', '예술', '만화·서브컬처', '442호', 'grimul_erica', [fee('20,000원', '신규'), fee('25,000원', '재가입')]),
  club('viva', 'VIVA', '예술', '뮤지컬', '414호', 'viva.erica', [fee('20,000원')], null, ['비바', '노래', '음악', '춤', '댄스']),
  club('e-rica', 'E-리카', '학술교양', 'e스포츠', '423호', 'esports_erica', [fee('15,000원')], null, ['이리카']),
  club('manchwi', '만취', '예술', '종합예술댄스', '422호', 'maaaaaaanchui', [fee('20,000원', '신규'), fee('15,000원', '재가입')]),
  club('ccc', 'CCC', '종교', '기독교', '405호', 'hyuerica_ccc', [fee('20,000원', '신규')], null, ['씨씨씨']),
  club('tal', '탈', '예술', '풍물패', '410호', 'tal_pungmul', [fee('10,000원', '신규'), fee('15,000원', '재가입')]),
  club('pin', 'PIN', '체육', '볼링', '434호', null, [fee('20,000원', '신규'), fee('15,000원', '재가입')], null, ['핀', '볼링동아리', '운동']),
  club('doh', 'DOH', '예술', '댄스', '448호', 'doh.official', [fee('10,000원', '신규'), fee('15,000원', '재가입')], null, ['디오에이치', '댄스']),
  club('muppy', '무삐', '예술', '연극', '416호', 'muppy_hy', [fee('20,000원', '신규'), fee('15,000원', '재가입')], null, ['무대밖의삐에로', '연극동아리']),
  club('hy-pass', 'HY-PASS', '체육', '축구', '435호', 'hy__pass', [fee('20,000원', '남자'), fee('15,000원', '여자')], null, ['하이패스', '축구동아리', '운동']),
  club('hyu-hiba', '하이바', '체육', '야구', '421호', 'hyu_hiba', [fee('30,000원', '신규'), fee('40,000원', '선수'), fee('10,000원', '매니저')]),
  club('mcpc', 'MCPC', '학술교양', '유학·교환학생', '443호', 'mcpc_hanyang', [fee('10,000원')], null, ['엠씨피씨', '유학', '교환학생', '국제교류', '영어', '영어회화']),
  club('herc', 'HERC', '체육', '러닝', '447호', 'herc.official', [fee('8,000원')], null, ['헐크', '달리기', '러닝크루', '런닝', '운동']),
  club('hycora', '하이코라', '학술교양', '코딩', '425호', 'hycora_hanyang', [fee('20,000원', '신규'), fee('10,000원', '재가입')], null, ['개발', 'AI', '컴퓨터']),
  ...
  club('hiclear', '하이클리어', '체육', '배드민턴', '433호', null, [], '미정', ['배드민턴동아리', '운동']),
  ...
  club('hy-climb', 'HY-CLIMB', '체육', '클라이밍', '409호', 'hyc_hy_climb', [fee('15,000원', '신규'), fee('10,000원', '재가입')], null, ['하이클라임', '암벽', '볼더링', '클라이밍']),
  club('rotaract', '로타랙트', '봉사', '봉사', '432호', 'hy_rotaract', [fee('10,000원')]),
  club('hany-baram', '하늬바람', '예술', '밴드', '404호', 'hany__baram', [fee('25,000원', '신규'), fee('20,000원', '재가입')], null, ['노래', '음악', '밴드']),
  ...
  club('arosaegim', '아로새김', '예술', '전시예술기획', '426호', 'aro__saegim', [fee('18,000원', '신규'), fee('14,000원', '재가입')]),
  club('hytec', '하이텍', '체육', '테니스', '407호', 'hytec_tennis', [fee('40,000원', '신규'), fee('30,000원', '재가입')], null, ['하이텍', 'HY-TeC', '테니스']),
  club('hacs', 'HACS', '봉사', '봉사', '436호', 'hacs_hyu', [fee('8,000원')]),
  club('maha', 'MAHA', '체육', '보드', '449호', 'maha_hanyang', [fee('25,000원', '신규'), fee('15,000원', '재가입')]),
  club('powderive', '탁우회', '체육', '탁구', '411호', 'powerdrive_hanyang', [fee('25,000원')], null, ['핑퐁', 'pingpong']),
  club('feel-so-good', '필소굿', '예술', '흑인음악', '415호', 'feelsooooooooooogood', [fee('15,000원', '신규'), fee('20,000원', '재가입')], null, ['힙합', 'R&B', '랩']),
  ...
  club('navigator', '네비게이토', '종교', '기독교', '440호', null, [fee('무료')]),
  club('uniform', '유니폼', '예술', '패션', '406호', 'uniform_erica', [fee('10,000원', '신규'), fee('8,000원', '재가입')]),
  club('hy-fly', 'HY-FLY', '학술교양', '드론', null, null, []),
  club('hanya', '한야', '체육', '야구부 서포터즈', null, 'hy_hanya', [], null, ['야구응원', '라이온즈', '야구']),
  club('sfc', '학생신앙운동(SFC)', '종교', '기독교', null, 'hanyang_erica_sfc', []),
  club('lux-mundi', 'LUX-MUNDI', '종교', '가톨릭', null, null, []),
];
